...
def _create_graph() -> StateGraph:
    ...
    Pipeline:
        search_topic → summarize_individual → merge_summaries
        → archive_results → END
    """
    ...
    # Chain edges - skip download_and_extract since Exa returns full text
    builder.add_edge("search_topic", "summarize_individual")
